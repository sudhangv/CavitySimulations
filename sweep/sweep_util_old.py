...
def get_freqs_Thz(hx , hy , a , w , h = 0.22, substrate = False, output_epsilon = False ):
    return convert_freq_to_Thz(get_freqs(hx , hy , a , w , h = 0.22, substrate = False, output_epsilon = False ))